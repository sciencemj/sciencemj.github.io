(function (root, factory) {
  ...
  function renderInspector(project, options) {
    ...
    return '<div class="inspector-stack">' +
      ...
      '<div class="source-editor"' + describedBy(errors, "preview") + '><div class="source-tabs" role="tablist" aria-label="Preview source"><button type="button" role="tab" data-source-mode="upload" aria-selected="' + (mode === "upload") + '">Upload</button><button type="button" role="tab" data-source-mode="existing" aria-selected="' + (mode === "existing") + '">Existing path</button></div>' +
